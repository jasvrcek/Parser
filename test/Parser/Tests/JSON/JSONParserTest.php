...
class Parser_Tests_JSON_JSONParserTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers Parser\JSON\JSONParser::jsonToObject
     */
    public function testJsonToObject()
    {
        //no recursion
        $testJson = '{"first_property": 1, "second_property": 2 }';
        $actual = $this->object->jsonToObject($testJson, '\\Parser\\TestObjects\\TestObject');
        ...
        $actual = $this->object->jsonToObject($testJson, '\\Parser\\TestObjects\\TestObject', array(
    ...
    /**
     * @covers Parser\JSON\JSONParser::jsonToCollection
     */
    public function testJsonToCollection()
    {
        ...
        $actual = $this->object->jsonToCollection($testJson, '\\Parser\\TestObjects\\TestObject');
